...
names <- read.table("Data/pdo.txt", skip=30, nrows=1, as.is = T)
pdo <- read.table("data/pdo.txt", skip=31, nrows=119, fill=T, col.names = names)
...
npgo <- read.table("data/npgo.txt", skip=10, nrows=828, fill=T, col.names = c("Year", "month", "value"))
